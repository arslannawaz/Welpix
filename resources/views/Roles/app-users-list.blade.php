    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <section class="users-list-wrapper">
                <a href="{{ url('admin/role/add') }}" class="btn btn-primary float-right mt-1">Add New Role</a> <br> </br> <br>
                <div class="users-list-filter border px-1">
                    {{-- <a href="{{ url('admin/role/add') }}" class="btn btn-primary float-right">Add New Role</a> --}}
                    <form>
