        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            <li class=" nav-item">
                <a href="#">
                    ...
                    <i class="menu-livicon" data-icon="drop"></i>
                    <span class="menu-title text-truncate" data-i18n="Projects">Dashboard</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a class="d-flex align-items-center" href="#">
                            <i class="bx bx-right-arrow-alt"></i>
                            <span class="menu-item text-truncate" data-i18n="List">Projects</span>
                        </a>
                    </li>
                    <li>
                        <a class="d-flex align-items-center" href="#">
                            <i class="bx bx-right-arrow-alt"></i>
                            <span class="menu-item text-truncate" data-i18n="List">Sales</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <!-- <li class=" nav-item"><a href="app-kanban.html"><i class="menu-livicon" data-icon="grid"></i><span class="menu-title text-truncate" data-i18n="Kanban">Kanban</span></a>
             ...
             <li class=" nav-item">
                <a href="#">
                    <i class="menu-livicon" data-icon="drop"></i>
                    <span class="menu-title text-truncate" data-i18n="Team Members">Estimates</span>
                </a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{ url('admin/estimate') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">All Estimates</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="#-user"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Estimate Tasks</span></a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item">
                <a href="#">
                    ...
                    <i class="menu-livicon" data-icon="drop"></i>
                    <span class="menu-title text-truncate" data-i18n="Customers">Projects</span>
                </a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{ url('/admin/project') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">All Projects</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="#-user"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">All Tasks</span></a>
                    </li>
                </ul>
            </li>
            {{-- <li class=" nav-item">
                <a href="{{ url('/admin/role') }}">
                    <i class="menu-livicon" data-icon="drop"></i>
                    <i class="menu-livicon" data-icon="users"></i>
                    <span class="menu-title text-truncate" data-i18n="User">Roles</span>
                </a> --}}
                {{-- <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href=""><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">List</span></a>
                    </li>
                    <!-- <li><a class="d-flex align-items-center" href="/add/role"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Add">Add</span></a>
                    </li>
                    ...
                    <li><a class="d-flex align-items-center" href="/edit/role"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="Edit">Edit</span></a>
                    </li> -->
                </ul> --}}
            {{-- </li> --}}
            {{-- <li class=" nav-item">
                ...
                {{-- <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{ url('admin/project/tasks') }}">
                        <i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Tasks</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{ url('admin/project/milestones') }}">
                        <i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Milestones</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{ url('admin/project/details') }}">
                        <i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Details</span></a>
                    </li>
                </ul> --}}
            {{-- </li> --}}
            {{-- <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="/admin/category"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">List</span></a>
                    </li>
                </ul>
            </li>
            <li class=" nav-item">
                <a href="#">
                    <i class="menu-livicon" data-icon="briefcase"></i>
                    <i class="menu-livicon" data-icon="drop"></i>
                    <span class="menu-title text-truncate" data-i18n="Demo">Demo</span>
                </a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="/admin/category"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">List</span></a>
                    </li>
            ...
            {{-- <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li>
                        <a class="d-flex align-items-center" href="#">
                            <i class="bx bx-right-arrow-alt"></i>
                            <span class="menu-item text-truncate" data-i18n="List">All Projects</span>
                        </a>
                    </li>
                    <li>
                        <a class="d-flex align-items-center" href="#">
                            <i class="bx bx-right-arrow-alt"></i>
                            <span class="menu-item text-truncate" data-i18n="List">Add New</span>
                        </a>
                    </li>
                </ul>
            </li> --}}
            <li class=" nav-item">
                ...
                <ul class="menu-content">
                    <li>
                        <a class="d-flex align-items-center" href="#">
                            <i class="bx bx-right-arrow-alt"></i>
                            <span class="menu-item text-truncate" data-i18n="List">Estimates</span>
                        </a>
                    </li>
                    <li>
                        <a class="d-flex align-items-center" href="#">
                            <i class="bx bx-right-arrow-alt"></i>
                            <span class="menu-item text-truncate" data-i18n="List">Invoices</span>
                        </a>
                    </li>
                    <li>
                        <a class="d-flex align-items-center" href="#">
                            <i class="bx bx-right-arrow-alt"></i>
                            <span class="menu-item text-truncate" data-i18n="List">Payments</span>
                        </a>
                    </li>
                </ul>
            </li>
             <li class=" nav-item">
                <a href="#">
                    {{-- <i class="menu-livicon" data-icon="users"></i> --}}
                    <i class="menu-livicon" data-icon="drop"></i>
                    <span class="menu-title text-truncate" data-i18n="Customers">Users</span>
                </a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{ url('admin/client') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Clients</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{ url('admin/client-user') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Client Users</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{ url('admin/team-member') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Team Members</span></a>
                    </li>
                </ul>
            </li>
             <li class=" nav-item">
                <a href="#">
                    {{-- <i class="menu-livicon" data-icon="users"></i> --}}
                    <i class="menu-livicon" data-icon="drop"></i>
                    <span class="menu-title text-truncate" data-i18n="Customers">Settings</span>
                </a>
                <ul class="menu-content">
                    <li><a class="d-flex align-items-center" href="{{ url('/admin/category') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Categories</span></a>
                    </li>
                    <li><a class="d-flex align-items-center" href="{{ url('/admin/role') }}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="List">Role</span></a>
                    </li>
