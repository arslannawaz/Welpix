                ...
                <div class="app-file-header-search flex-grow-1">
                    ...
                    <div class="row d-none">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <a href="javascript:void(0)" class="btn btn-light-primary  demo">Demo</a>
                            <a href="javascript:void(0)" class="btn btn-light-primary upload">Upload</a>
                            <div class="btn-group">
                                <div class="dropdown">
                                    <a href="javascript:void(0)" class="btn btn-light-primary dropdown-toggle"
                                        id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">Example</a>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item catelog" href="javascript:void(0);">Catelog</a>
                                        <a class="dropdown-item creative" href="javascript:void(0);">Creative</a>
                                        <a class="dropdown-item motion" href="javascript:void(0);">Motion</a>
                                    </div>
                                </div>
                            </div>
                            <a href="javascript:void(0)" class="btn btn-light-primary estimate">Estimates</a>
                            <a href="javascript:void(0)" class="btn btn-light-primary " id="tasks">Tasks</a>
                            <a href="javascript:void(0)" class="btn btn-light-primary " id="messages">Messages</a>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <ul class="nav nav-pills">
                                <li class="nav-item">
                                    <a class="nav-link active" id="demo" data-toggle="pill" href="#demo"
                                        aria-expanded="true">Demo</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="upload-tab" data-toggle="pill" href="#upload"
                                        aria-expanded="false">Upload
                                    </a>
                                </li>
                                <li>
                                    <div class="btn-group">
                                        <div class="dropdown">
                                            <a href="javascript:void(0)" class="btn btn-light-primary dropdown-toggle"
                                                ...
                                                aria-expanded="false">Example</a>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item " id="catalogue-tab" data-toggle="pill"
                                                    href="#catalogue" aria-expanded="true">Catalogue
                                                </a>
                                                <a class="dropdown-item" id="creative-tab" data-toggle="pill"
                                                    href="#creative" aria-expanded="true">
                                                    Creative
                                                </a>
                                                <a class="dropdown-item" id="motion-tab" data-toggle="pill"
                                                    href="#motion" aria-expanded="true">
                                                    Motion
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="estimate-tab" data-toggle="pill" href="#estimate"
                                        aria-expanded="false">Estimate
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="task-tab" data-toggle="pill" href="#task"
                                        aria-expanded="false">Task
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="message-tab" data-toggle="pill" href="#message"
                    ...
                    {{-- <p class="line-height-1">
                        <span class="h5 d-block font-weight-bold">Lead</span>
                        Lead@gmail.com
                    </p> --}}
                </div>
            </div>
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="demo" aria-expanded="true"
                    aria-labelledby="base-pill31">
                    @include('estimate.partial.tab-content.demo')
                </div>
                <div role="tabpanel" class="tab-pane" id="upload" aria-expanded="true" aria-labelledby="base-pill31">
                    <h1>
                        Hello
                    </h1>
                </div>
            </div>
            <div class="app-file-content p-2 d-none" id="area">
                @include('estimate.partial.tab-content.demo')
                {{-- Start Messages --}}
                ...
                {{-- <div class="form-check-inline">
                    <label class="form-check-label" for="radio1">
                        <input type="radio" class="form-check-input" id="radio1" name="type" value="cat">Catelog
                    </label>
                </div>
                <div class="form-check-inline">
                    <label class="form-check-label" for="radio2">
                        <input type="radio" class="form-check-input" id="radio2" name="type" value="hero">Hero
                    </label>
                </div>
                <div class="form-check-inline">
                    <label class="form-check-label" for="radio2">
                        <input type="radio" class="form-check-input" id="radio2" name="type" value="">Animation
                    </label>
                </div><span> | </span>
                <div class="form-check-inline">
                    <label class="form-check-label" for="radio2">
                        <input type="radio" class="form-check-input" id="radio2" name="type-2" value="">Minimalistic
                    </label>
                </div>
                <div class="form-check-inline">
                    <label class="form-check-label" for="radio2">
                        <input type="radio" class="form-check-input" id="radio2" name="type-2" value="">Simple Props
                    </label>
                </div>
                <div class="form-check-inline">
                    <label class="form-check-label" for="radio2">
                        <input type="radio" class="form-check-input" id="radio2" name="type-2" value="">Custome
                    </label>
                </div> --}}
                ...
                {{-- <div class="card mt-1" style="width:100%">
                        <div class="card-header  d-flex justify-content-center">
                            <a href="#" class="text-decoration-none text-dark font-weight-bold h5 catelog">Catelog - </a>
                            <a href="#" class="text-decoration-none ml-1 text-dark  font-weight-bold h5 creative">Creative - </a>
                            <a href="#" class="text-decoration-none ml-1 text-dark  font-weight-bold h5 motion">Motion</a>
                        </div>
                        <div class="card-body d-flex justify-content-center catelog-img">
                            <img class="img-fluid rounded mt-1 ml-1" src="{{asset('img/2.jpg')}}" alt="img" width="400"
                style="height:300px">
                <img class="img-fluid rounded mt-1 ml-1" src="{{asset('img/2.jpg')}}" alt="img" width="400"
                    style="height:300px">
            </div>
        </div> --}}
        {{-- <iframe src="{{asset('vedeo/demo.mp4')}}" height="350px" width="100%" class="embed-responsive-item mt-2"
        allpwfullscreen="true"></iframe> --}}
        {{-- </div> --}}
    </div>
</div>
