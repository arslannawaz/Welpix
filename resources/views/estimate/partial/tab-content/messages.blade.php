...
<div class="content-area-wrapper mt-0 ml-0">
                    ...
                    <div class="chat-user-profile-scroll">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href="javascript:void(0);" class="d-flex align-items-center"><i
                                        class="bx bx-block mr-50"></i> Blocked
                                    Contact</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="chat-sidebar-list-wrapper pt-2">
                    ...
                    <ul class="chat-sidebar-list">
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="avatar m-0 mr-50"><img
                                        src="../../../app-assets/images/portrait/small/avatar-s-26.jpg" height="36"
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="avatar m-0 mr-50"><img
                                        src="../../../app-assets/images/portrait/small/avatar-s-7.jpg" height="36"
                                        width="36" alt="sidebar user image">
                                    <span class="avatar-status-online"></span>
                                </div>
                                <div class="chat-sidebar-name">
                                    <h6 class="mb-0">Kristopher Candy</h6><span class="text-muted">jelly
                                        jelly</span>
                                </div>
                            </div>
                        </li>
                    </ul>
                    <h6 class="px-2 pt-2 pb-25 mb-0">CONTACTS<i class="bx bx-plus float-right cursor-pointer"></i>
                    </h6>
                    <ul class="chat-sidebar-list">
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="avatar m-0 mr-50"><img
                                        src="../../../app-assets/images/portrait/small/avatar-s-8.jpg" height="36"
                                        width="36" alt="sidebar user image">
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="avatar m-0 mr-50"><img
                                        src="../../../app-assets/images/portrait/small/avatar-s-5.jpg" height="36"
                                        width="36" alt="sidebar user image">
                                    <span class="avatar-status-online"></span>
                                </div>
                                <div class="chat-sidebar-name">
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="avatar m-0 mr-50"><img
                                        src="../../../app-assets/images/portrait/small/avatar-s-9.jpg" height="36"
                                        width="36" alt="sidebar user image">
                                    <span class="avatar-status-busy"></span>
                                </div>
                                <div class="chat-sidebar-name">
                                    <h6 class="mb-0">Heather Howell</h6><span class="text-muted">cheesecake
                                        toffee</span>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="avatar m-0 mr-50"><img
                                        src="../../../app-assets/images/portrait/small/avatar-s-14.jpg" height="36"
                                        width="36" alt="sidebar user image">
                                    <span class="avatar-status-online"></span>
                                </div>
                                <div class="chat-sidebar-name">
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="avatar m-0 mr-50"><img
                                        src="../../../app-assets/images/portrait/small/avatar-s-3.jpg" height="36"
                                        width="36" alt="sidebar user image">
                                    <span class="avatar-status-offline"></span>
                                </div>
                                <div class="chat-sidebar-name">
            ...
            <div class="content-body">
                ...
                <section class="chat-window-wrapper">
                    <div class="chat-start">
                        ...
                        <h5 class="d-none d-lg-block py-50 text-bold-500">Select a contact to start a chat!</h5>
                        <button
                            class="btn btn-light-primary chat-start-text chat-sidebar-toggle d-block  py-50 px-1">Start
                            Conversation!</button>
                    </div>
                                    ...
                                    <span class="dropdown">
                                        ...
                                        <span class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <a class="dropdown-item" href="JavaScript:void(0);"><i
                                                    class="bx bx-pin mr-25"></i> Pin to top</a>
                                            <a class="dropdown-item" href="JavaScript:void(0);"><i
                                                    class="bx bx-trash mr-25"></i> Delete chat</a>
                                            <a class="dropdown-item" href="JavaScript:void(0);"><i
                                                    class="bx bx-block mr-25"></i> Block</a>
                                        </span>
                                    </span>
                                </div>
                            </header>
                ...
                <section class="chat-profile">
                    <header class="chat-profile-header text-center border-bottom">
                        ...
                        <div class="my-2">
                            <div class="avatar">
                                <img src="../../../app-assets/images/portrait/small/avatar-s-26.jpg" alt="chat avatar"
                                    height="100" width="100">
                            </div>
